...
# ----------------- Глобальная панель: заголовок + "Обновить всё" -----------------
...
ALL_TOKEN = st.session_state["refresh_all"]
# -------------------------------------------------------------------------------
...
# ---- Мощность: активная / полная / реактивная / неактивная ----
...
st.plotly_chart(
    ...
    use_container_width=True,
    config={"responsive": True},
    key=f"grp_power_{ALL_TOKEN}_{token_p}",
)
...
st.plotly_chart(
    ...
    use_container_width=True,
    config={"responsive": True},
    key=f"grp_curr_{ALL_TOKEN}_{token_c}",
)
...
st.plotly_chart(
    ...
    use_container_width=True,
    config={"responsive": True},
    key=f"grp_urms_{ALL_TOKEN}_{token_ur}",
)
...
st.plotly_chart(
    ...
    use_container_width=True,
    config={"responsive": True},
    key=f"grp_uline_{ALL_TOKEN}_{token_ul}",
)
...
st.plotly_chart(
    ...
    use_container_width=True,
    config={"responsive": True},
    key=f"grp_pf_{ALL_TOKEN}_{token_pf}",
)
...
st.plotly_chart(
    ...
    use_container_width=True,
    config={"responsive": True},
    key=f"grp_ang_{ALL_TOKEN}_{token_ang}",
)
...
if freq_cols:
    ...
    st.plotly_chart(
        ...
        use_container_width=True,
        config={"responsive": True},
        key=f"grp_freq_{ALL_TOKEN}_{token_f}",
    )
else:
